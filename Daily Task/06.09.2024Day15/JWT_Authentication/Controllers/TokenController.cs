...
namespace APICodeFirst.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        //public TokenController(IConfiguration configuration, EmployeeContext con)
        //{
        ...
        //    if (ValidateUser(user.EmailId, user.Password))
        //    {
        ...
        //    var user = users.FirstOrDefault(u => u.EmailId == email && u.Password == password);
        //    if (user != null)
        //    {
        //        return true;
        //    }
