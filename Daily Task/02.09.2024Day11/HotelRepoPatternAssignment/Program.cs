...
builder.Services.AddDbContext<HotelContext>(options => options.UseSqlServer("data source=PTSQLTESTDB01;database=HotelRepoPattern;integrated security=true;trustservercertificate =true;"));
